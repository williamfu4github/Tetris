...
Position JBlock::rotationWallKick(TetrominoBlock::TetrominoPhase blockPhase, int attempt) {
...
// PRE: attempt must be in [0, 4]
Position JBlock::getRotationWallKick(int attempt) const {
    return JBlock::rotationWallKick(blockPhase, attempt);
}
